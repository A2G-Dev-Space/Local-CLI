 ...
 *
 * Tools for managing table of contents:
 * - word_insert_toc: Insert a table of contents
 * - word_update_toc: Update all tables of contents
 * - word_delete_toc: Delete all tables of contents
 */
