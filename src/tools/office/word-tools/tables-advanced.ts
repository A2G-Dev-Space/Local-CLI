 ...
 * - word_add_table_row: Add a row to a table
 * - word_add_table_column: Add a column to a table
 * - word_delete_table_row: Delete a row from a table
 * - word_delete_table_column: Delete a column from a table
 * - word_get_table_info: Get table information
 */
