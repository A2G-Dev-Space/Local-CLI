...
/**
 * Get context tracker instance (for backwards compatibility)
 */
export function getContextTracker(): ContextTrackerClass {
  return contextTracker;
}

/**
 * Reset context tracker (for backwards compatibility)
 */
