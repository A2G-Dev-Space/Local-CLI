...
- Execute ANY PowerShell command (git, npm, python, docker, etc.)
...
**Office Agents** (always available on Windows):
...
- \`powershell\` - Run ANY PowerShell command (git, npm, python, docker, curl, etc.)
